...
const CartWidget = () =>{
    ...
    return(cartTotal()> 0)?
        <Link to={"/cart"} type="button" className="btn btn-outline-dark position-relative "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-cart2 m-3" viewBox="0 0 16 16">
